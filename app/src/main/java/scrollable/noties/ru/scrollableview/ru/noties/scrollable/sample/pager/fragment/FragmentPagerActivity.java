package scrollable.noties.ru.scrollableview.ru.noties.scrollable.sample.pager.fragment;
...
public class FragmentPagerActivity extends BaseActivity {
    ...
    public void onCreate(Bundle sis) {
        ...
        final FragmentPagerAdapter adapter =
                new FragmentPagerAdapter(getSupportFragmentManager(), items(getApplicationContext()));
